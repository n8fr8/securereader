...
convert -strip -background none $f ../../app/res/drawable-xhdpi/${f/.svg}.png
convert -strip -background none $f -resize 75% ../../app/res/drawable-hdpi/${f/.svg}.png
convert -strip -background none $f -resize 50% ../../app/res/drawable-mdpi/${f/.svg}.png
convert -strip -background none $f -resize 37.5% ../../app/res/drawable-ldpi/${f/.svg}.png

# convert -strip -background none $f temp.png
# diff temp.png ../../app/res/drawable-xhdpi/${f/.svg}.png >/dev/null
# if [ `echo $?` -eq 0 ]
# then
#	echo Same
# else
