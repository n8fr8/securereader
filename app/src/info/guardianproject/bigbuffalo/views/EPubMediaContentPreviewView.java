...
public class EPubMediaContentPreviewView extends FrameLayout implements MediaDownloaderCallback
{
	...
	{
		Toast.makeText(this.getContext(), "EPub Downloaded 1", Toast.LENGTH_SHORT).show();
		...
		if (mHasBeenRecycled)
		{
			Log.v("EPubMediaContentPreviewView", "Media downloaded, but already recycled. Ignoring.");
			return;
		}
		...
		// Do something here!
		Toast.makeText(this.getContext(), "EPub Downloaded 2", Toast.LENGTH_SHORT).show();
	}
