...
import info.guardianproject.bigbuffalo.widgets.GroupView;
...
public class SettingsActivity extends FragmentActivityWithMenu
{
	...
	private void populateProfileTab()
	{
		...
		this.hookupRadioButton(tabView, "uiLanguage", Settings.UiLanguage.class, R.id.rbUiLanguageEnglish, R.id.rbUiLanguageFarsi);
